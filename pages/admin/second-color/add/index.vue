      ...
      <div class="mt-4 row">
        <div class="col-8">
          <div class="h-fit border bg-white rounded shadow-sm p-3">
            ...
            <div class="admin-form__control mt-4 w-100">
              <label
                for="nameEn"
                class="admin-form__label mb-2 px-1 text-capitalize"
                >NameEn</label
              >
              <input
                ...
                name="nameEn"
                id="nameEn"
                v-model="$store.state.secondc.nameEn"
                placeholder="NameEn"
              />
            </div>
            ...
            <div class="admin-form__control mt-4 w-100">
              ...
              <input
                ...
                name="nameAr"
                id="nameAr"
                v-model="$store.state.secondc.nameAr"
                placeholder="nameAr"
              />
            </div>
            ...
            <input
              v-model="$store.state.secondc.color"
              type="color"
...
export default {
  methods: {
    async addColor() {
      await this.$store.dispatch("secondc/add");
    },
  },
